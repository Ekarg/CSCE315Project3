...
public class GLRenderer implements GLSurfaceView.Renderer {
    ...
    private Line x_axis; // x axis for the compass rose 
    ...
    public volatile float mAngleX; //how the image should be rotated in the x direction
    public volatile float mAngleY; //how the image should be rotated in the y direction
    public volatile float mAngleZ; //how the image should be rotated in the z direction
